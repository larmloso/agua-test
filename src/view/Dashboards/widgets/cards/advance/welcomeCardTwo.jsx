...
import illustartion from "../../../../../assets/images/illustrations/welcome-illustration-2.svg";

export default function WelcomeCardTwo() {
  return (
    <Card className="da-border-color-black-40 da-card-3 da-welcomeCard">
      <Row>
        ...
        <img src={illustartion} className="da-img-2" alt="Congratulations⚡️" />
      </Row>
    </Card>
  );
}
