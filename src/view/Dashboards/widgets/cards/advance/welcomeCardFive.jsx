...
import illustartion from "../../../../../assets/images/illustrations/welcome-illustration-5.svg";

export default function WelcomeCardFive() {
  return (
    <Card className="da-border-color-black-40 da-card-3 da-welcomeCard">
      <Row>
        ...
        <img src={illustartion} className="da-img-5" alt="Congratulations⚡️" />
      </Row>
    </Card>
  );
}
