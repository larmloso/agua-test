...
import illustartion from "../../../../../assets/images/illustrations/welcome-illustration-1.svg";

export default function WelcomeCardOne() {
  return (
    <Card className="da-border-color-black-40 da-mb-32 da-card-3 da-welcomeCard">
      <Row>
        ...
        <img src={illustartion} className="da-img-1" alt="Congratulations" />
      </Row>
    </Card>
  );
}
