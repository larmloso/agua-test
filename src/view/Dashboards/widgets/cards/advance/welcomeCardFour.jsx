...
import illustartion from "../../../../../assets/images/illustrations/welcome-illustration-4.svg";

export default function WelcomeCardFour() {
  return (
    <Card className="da-border-color-black-40 da-card-3 da-welcomeCard">
      <Row>
        ...
        <img src={illustartion} className="da-img-4" alt="Congratulations⚡️" />
      </Row>
    </Card>
  );
}
