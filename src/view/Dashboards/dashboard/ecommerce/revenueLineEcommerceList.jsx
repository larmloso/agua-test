      ...
      <Row>
        <Col className="da-mb-16" span={24}>
          <Row justify="space-between" align="middle">
            <h5 className="da-mb-0">Revenue</h5>
        ...
        <Col span={24}>
          ...
          <Row align="middle">
            ...
            <div className="da-ml-32">
              <p className="da-mb-0">Total Expense</p>

              <Row align="middle" justify="end">
                <h5 className="da-mb-0 da-mr-4">$ 4,253</h5>
                ...
                <p className="da-mb-0 da-input-description da-text-color-primary-1">
                  10%
                </p>
              </Row>
            </div>
          ...
          <Row align="middle">
            ...
            <div className="da-ml-32">
              <p className="da-mb-0">Total Profit</p>
              ...
              <Row align="middle" justify="end">
                ...
                <p className="da-mb-0 da-input-description da-text-color-warning-1">
                  10%
                </p>
              </Row>
            </div>
